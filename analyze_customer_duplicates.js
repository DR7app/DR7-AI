// Analyze duplicate customers in customers_extended table
...
async function analyzeCustomerDuplicates() {
    ...
    try {
        ...
        console.log('   2. If everything looks correct, I will create and run the merge script');
        console.log('');
