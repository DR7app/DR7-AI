...
SET price_options = '[{"label":"3h","price":19.90},{"label":"4h","price":23.60},{"label":"5h","price":29.50},{"label":"6h","price":35.40},{"label":"7h","price":41.30}]'::jsonb
WHERE UPPER(name) LIKE '%COURTESY DRIVE%';

-- Add price options to Supercar Experience
UPDATE car_wash_services
SET price_options = '[{"label":"3h","price":189.00},{"label":"4h","price":276.00},{"label":"5h","price":345.00},{"label":"6h","price":414.00},{"label":"7h","price":483.00}]'::jsonb
