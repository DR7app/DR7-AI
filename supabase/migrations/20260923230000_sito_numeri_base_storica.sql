-- 23/09/2026: base storica prima della piattaforma, sommata ai numeri live.
-- Contratti firmati = 4.000 + quelli firmati in piattaforma.
-- Fatturato generato = 2.500.000 EUR + fatture emesse in piattaforma.
insert into public.sito_contatori (chiave, valore) values
  ('contratti_storici', 4000),
  ('fatturato_storico', 2500000)
