-- Update the auto car wash trigger function to set payment_status to 'paid' instead of 'pending'
-- This only updates the function, not the triggers (which already exist)
