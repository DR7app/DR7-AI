...
export const handler: Handler = async (event) => {
    ...
    // Noleggio: nessun gate sulla firma. Il codice parte sul pagamento,
    // come per il car wash. Cambio richiesto perche' il flusso "post-firma"
    // non era affidabile (signature-complete poteva morire prima del blocco
    // privilege). Idempotente via dr7_privilege_sent_at, niente doppio invio.
