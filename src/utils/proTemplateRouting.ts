...
export const PENDING_EVENTS: ReadonlySet<string> = new Set([
  ...
  // 2026-08-14 COLLEGATI: boat_new_admin (MareBookingModal.save, solo alla
  // creazione) e boat/heli/stay_cancelled (NoleggioServiceTab.deleteBookingRow).
  'boat_da_saldare_customer',
  'heli_new_admin', 'heli_da_saldare_customer',
  'stay_new_admin', 'stay_da_saldare_customer',
