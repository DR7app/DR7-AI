  ...
  useEffect(() => {
    if (editData && isOpen) {
      setForm({
        ...
        delivery_zip: editData.delivery_zip || '',
        delivery_province: editData.delivery_province || '',
        delivery_notes: editData.delivery_notes || '',
        pickup_street: editData.pickup_street || '',
        pickup_city: editData.pickup_city || '',
        pickup_zip: editData.pickup_zip || '',
        pickup_province: editData.pickup_province || '',
        pickup_notes: editData.pickup_notes || '',
      })
    } else if (isOpen) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const record: any = {
        ...
        delivery_street: form.delivery_enabled ? form.delivery_street : '',
        delivery_city: form.delivery_enabled ? form.delivery_city : '',
        delivery_zip: form.delivery_enabled ? form.delivery_zip : '',
        delivery_province: form.delivery_enabled ? form.delivery_province : '',
        delivery_notes: form.delivery_enabled ? form.delivery_notes : '',
        delivery_fee: form.delivery_enabled ? parseFloat(form.delivery_fee) : 0,
        pickup_enabled: form.pickup_enabled,
        pickup_street: form.pickup_enabled ? form.pickup_street : '',
        pickup_city: form.pickup_enabled ? form.pickup_city : '',
        pickup_zip: form.pickup_enabled ? form.pickup_zip : '',
        pickup_province: form.pickup_enabled ? form.pickup_province : '',
