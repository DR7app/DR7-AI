...
// Il contatore vive in src/hooks/useBirthdayCount.ts: importarlo da qui
// tirerebbe l'intera tab nel chunk principale del gestionale.
export { useBirthdayCount } from '../../../hooks/useBirthdayCount'
