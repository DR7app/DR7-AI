...
const MESSAGE_CATEGORIES: { label: string; keys: string[] }[] = [
  { label: 'Noleggio', keys: ['rental_new', 'rental_new_customer', 'rental_new_admin', 'rental_confirmed_unpaid', 'rental_modified', 'supercar_day_before', 'utilitaria_day_before', 'checkin_reminder', 'checkout_reminder', 'deposit_return_iban'] },
