...
export default function RecensioniEditor({ copy, setCopy }: { copy: FooterCopy; setCopy: (next: FooterCopy) => void }) {
    ...
    const dopoGoogle = copy.manual_reviews_after_google !== false
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-[13px] text-theme-text-secondary mt-1">
                    La fascia recensioni in fondo a ogni pagina. Le recensioni di Google arrivano da sole; qui si scrivono quelle a mano.
            ...
            <section className="border border-theme-border rounded-2xl p-5 bg-theme-bg-primary shadow-sm space-y-4">
                ...
                <label className="flex items-start justify-between gap-4 py-1 cursor-pointer">
                    <span className="min-w-0">
                        <span className="block text-[13px] font-medium text-theme-text-primary">Mostra anche queste recensioni dopo quelle Google</span>
                        <span className="block text-[11px] text-theme-text-secondary mt-0.5">
                            Spento: quando Google risponde si vedono solo le sue. Le recensioni qui sotto restano comunque finche' Google non ha risposto, o se non risponde.
                        </span>
                    </span>
            ...
            <section className="border border-theme-border rounded-2xl p-5 bg-theme-bg-primary shadow-sm space-y-4">
                <h3 className="text-[14px] font-semibold text-theme-text-primary">Recensioni scritte a mano ({elenco.length})</h3>
