            ...
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={aggregates.daily} margin={{ top: 5, right: 5, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip contentStyle={{ background: '#1f2937', border: '1px solid #374151', borderRadius: 8, fontSize: 12 }} formatter={(v: number) => fmtEur(v)} labelFormatter={(d) => `Giorno ${d}`} />
              ...
              <div className="h-56">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={aggregates.topSuppliers.slice(0, 5)} layout="vertical" margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
                    ...
                    <Tooltip contentStyle={{ background: '#1f2937', border: '1px solid #374151', borderRadius: 8, fontSize: 12 }} formatter={(v: number) => fmtEur(v)} />
