...
function SocialLinksSubTab() {
    ...
    async function handleSave() {
        ...
        try {
            ...
            // (Centralina Pro sezioni: categories, fasce, insurance, ecc.)
...
export default function CampagnaMarketingTab() {
    ...
    // Top-level sub-tab: campagne (existing flow) vs social-links (URL config)
    const [subTab, setSubTab] = useState<'campagne' | 'social'>('campagne')
    ...
    return (
        <div className="space-y-6">
            <div className="bg-theme-bg-secondary/50 p-4 rounded-lg border border-theme-border">
                <h2 className="text-xl font-bold text-theme-text-primary">Marketing</h2>
            ...
            {/* Sub-tab: Campagne | Social Links */}
            <div className="flex gap-2 border-b border-theme-border">
                <button
                    onClick={() => setSubTab('campagne')}
                    className={[
            ...
            {subTab === 'social' && <SocialLinksSubTab />}
