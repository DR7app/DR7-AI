...
export default function FatturaTab() {
  ...
  // Regola del click singolo su tutto cio' che parte davvero: due click
        ...
        {view === 'emesse' && (
          <div className="flex gap-2 items-center">
            ...
            {draftInvoices.length > 0 && (
              <button
                onClick={() => inviaTutteLeBozze()}
                disabled={inviandoBozze}
                          ...
                          <>
                            ...
                            <div
                              ...
                              {(!invoice.sdi_status || invoice.sdi_status === 'draft' || invoice.sdi_status === 'error' || invoice.sdi_status === 'rejected' || invoice.sdi_status === 'scartata') ? (
                                <button disabled={inviandoSdi} onClick={() => { inviaSdi(invoice); setOpenActionsId(null) }} className="w-full px-3 py-2 text-xs text-theme-text-primary hover:bg-theme-bg-tertiary disabled:opacity-50 flex items-center gap-2">
