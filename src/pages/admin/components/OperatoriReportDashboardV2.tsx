...
export default function OperatoriReportDashboardV2({ onSwitchView }: OperatoriReportDashboardV2Props = {}) {
    ...
    // 25/09/2026: il periodo parte dal mese corrente fino a oggi; lo cambia la
    // barra Periodo comune. Date vuote ignorate (servono sempre due date).
            ...
            <div className="bg-theme-bg-secondary border border-theme-border rounded-lg p-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <DateRangeFilter
                      ...
                      onChange={r => { if (r.from && r.to) setRange({ from: r.from, to: r.to }) }}
                      conTutto={false}
                      compact
                    />
                    <button
