    ...
    if (loading) {
        return (
            <div className="text-center py-8">
                ...
                <p className="text-white">Caricamento check-in di oggi...</p>
            </div>
        )
    }
        ...
        <div className="space-y-6">
            <div className="bg-gray-900 rounded-lg p-4">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold text-white">Check-In Oggi</h2>
            ...
            {bookings.length === 0 ? (
                <div className="bg-gray-900 rounded-lg p-8 text-center">
                    <p className="text-gray-400">Nessun ritiro previsto per oggi</p>
                </div>
            ) : (
