...
export default function CustomerWalletTab() {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      {/* La ricarica a PIU' clienti sta in Marketing > Wallet: qui si lavora
          su una scheda alla volta. Una stessa tab in due sezioni fa rimbalzare
          la barra laterale, quindi non si duplica. */}
