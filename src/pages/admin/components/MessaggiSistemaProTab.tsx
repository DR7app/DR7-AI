...
const TEMPLATE_VAR_GROUPS: VarGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'second_driver_line', description: 'Riga secondo guidatore — una tantum (vuoto se non aggiunto)', example: 'Secondo guidatore (una tantum) = €30,00' },
            { key: 'second_driver_total', description: 'Solo importo secondo guidatore una tantum (vuoto se non aggiunto)', example: '€30,00' },
            { key: 'second_driver_daily', description: 'DEPRECATO (era tariffa /giorno, ora coincide col totale). Usa second_driver_total.', example: '€30,00' },
