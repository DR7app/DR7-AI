...
const TEMPLATE_VAR_GROUPS: VarGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: 'second_driver_line', description: 'Riga secondo guidatore (vuoto se non aggiunto)', example: 'Secondo guidatore = €60,00' },
            { key: 'second_driver_total', description: 'Solo importo secondo guidatore (vuoto se non aggiunto)', example: '€60,00' },
            { key: 'second_driver_daily', description: 'Solo tariffa giornaliera secondo guidatore (vuoto se non aggiunto)', example: '€10,00' },
