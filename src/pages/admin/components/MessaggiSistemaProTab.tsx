...
const PRO_MESSAGE_CATEGORIES: { label: string; templates: ProTemplateDef[] }[] = [
  ...
  },
  {
    ...
    templates: [
      ...
      { key: 'pro_conferma_pagamento',         label: 'Conferma Pagamento',            description: 'Conferma ricezione pagamento (estensione, top-up, danni/penali)' },
      { key: 'pro_conferma_da_saldare',        label: 'Conferma Prenotazione Da Saldare', description: 'Quando admin spunta "Conferma Prenotazione" su un booking ancora da saldare — slot separato da Conferma Pagamento per non sovrapporre i due messaggi' },
