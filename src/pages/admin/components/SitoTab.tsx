    ...
    return (
        <div className="space-y-6">
            ...
            <section className="border border-theme-border rounded-2xl p-5 bg-theme-bg-primary shadow-sm space-y-4">
                ...
                <FieldText label="Immagine dietro le recensioni (percorso o URL)" value={copy.reviews_image ?? ''} onChange={v => updateField('reviews_image', v)} />
                <p className="text-[11px] text-theme-text-secondary">
                    ...
                    L'immagine sta dietro alla sezione, appoggiata a destra e spenta verso
                    sinistra dove corre il testo: lasciala vuota per non mostrarne nessuna.
                </p>
            </section>
...
const MENU_ITEM_FIELDS: { key: string; name: string; titleIt: string; titleEn: string; subIt: string; subEn: string; img: string }[] = [
    ...
    { key: 'investitori', name: 'Relazioni Investitori', titleIt: 'Relazioni Investitori', titleEn: 'Investor Relations', subIt: 'Numeri, azionisti e governance di DR7 S.p.A.', subEn: 'Figures, shareholders and governance of DR7 S.p.A.', img: '/menu-business.jpeg' },
