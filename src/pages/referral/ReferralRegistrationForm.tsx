        ...
        <form onSubmit={handleSendOtp} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-500 focus:border-[#19C2D6] focus:ring-1 focus:ring-[#19C2D6] outline-none font-mono"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-[#19C2D6] text-white font-bold rounded-xl hover:bg-[#0A8FA3] transition-colors disabled:opacity-50"
          >
