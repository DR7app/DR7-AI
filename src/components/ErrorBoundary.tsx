...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      if (this.state.isChunkError) {
        return (
          <div className="min-h-screen flex items-center justify-center bg-theme-bg-primary p-4">
            <div className="bg-theme-bg-tertiary rounded-xl p-8 max-w-md w-full text-center border border-theme-border">
              <div className="text-4xl mb-4">&#128260;</div>
              <h1 className="text-xl font-bold text-theme-text-primary mb-2">Aggiornamento disponibile</h1>
              ...
              <p className="text-theme-text-muted text-xs mb-6 font-mono">
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-theme-bg-primary p-4">
          <div className="bg-theme-bg-tertiary rounded-xl p-8 max-w-lg w-full text-center border border-theme-border">
            <h1 className="text-xl font-bold text-theme-text-primary mb-2">Errore imprevisto</h1>
            <p className="text-theme-text-muted mb-4 text-sm">
              Si è verificato un errore. Puoi provare a ripristinare o ricaricare la pagina.
            </p>
            <div className="bg-theme-bg-primary rounded-lg p-3 mb-6 text-left max-h-40 overflow-auto">
              <p className="text-red-400 text-xs font-mono break-all">
                {this.state.error?.message}
              </p>
              {this.state.errorInfo && (
                <p className="text-theme-text-muted text-xs font-mono mt-2 whitespace-pre-wrap">
